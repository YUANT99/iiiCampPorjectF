...
<jsp:include page="TopwithLeftNav.jsp" />
 ...
 <form method="post" action="<c:url value='/PostAddServletAction' />">      
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">論壇類別:</label>
                <input type="text" name="forumname" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">貼文分類:</label>
